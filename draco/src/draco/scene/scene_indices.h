...
namespace std {
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(MeshIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(MeshInstanceIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(MeshGroupIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(SceneNodeIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(AnimationIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(SkinIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(LightIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(InstanceArrayIndex)
}
