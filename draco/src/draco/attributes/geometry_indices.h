...
namespace std {
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(AttributeValueIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(PointIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(VertexIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(CornerIndex)
DEFINE_NEW_DRACO_INDEX_TYPE_HASH_OPERATOR(FaceIndex)
}
